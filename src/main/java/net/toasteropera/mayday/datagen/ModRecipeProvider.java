...
//        List<ItemLike> BISMUTH_SMELTABLES = List.of(ModItems.RAW_BISMUTH, ModBlocks.DEEPSLATE_BISMUTH_ORE);
//
...
//                //optionally name the recipe manually
//                .save(recipeOutput, "mayday:bismuth_from_block");
//
